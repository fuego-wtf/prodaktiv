...
Voice events are transmitted from the LIN34R device to the mobile app via BLE notifications. This enables real-time feedback for voice recording state changes.
