...
│
└── docs/
    ├── LIN34R_ARCHITECTURE.md       # Architecture overview
    └── plans/
...
lin34r-web/                          # Marketing Website (new repo)
├── package.json
├── vite.config.ts
├── tsconfig.json
│
...
lin34r-firmware/                     # ESP32 Controller (new repo)
├── platformio.ini
├── README.md
│
├── src/
...
─────────────────────────────────────────────────────────────────────────────
    ...
    ┌─────────────────────────────────────────────────────────────────────┐
    │ T-001: Initialize lin34r plugin repo                                 │
...
─────────────────────────────────────────────────────────────────────────────
    ...
    ┌─────────────────────────────────────────────────────────────────────┐
    │ T-022: Initialize lin34r-web repo                                    │
...
─────────────────────────────────────────────────────────────────────────────
    ...
    ┌─────────────────────────────────────────────────────────────────────┐
    │ T-027: Initialize lin34r-firmware repo                               │
