        ...
        <div className="flex justify-between items-center p-4 border-b-2 border-black bg-zinc-50">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-zinc-500 font-mono">Prodaktiv Physical Controller</p>
            </div>
          </div>
          <button
            onClick={onClose}
    ...
    <div className="space-y-3">
      ...
      <ol className="space-y-3 text-sm">
        ...
        <li className="flex items-start gap-3">
          ...
          <span className="text-zinc-600 pt-0.5">Select "Prodaktiv" from the browser's device picker</span>
        </li>
      </ol>
    </div>
  ...
  <div className="text-center py-12 space-y-6">
    ...
    <div>
      ...
      <p className="text-zinc-500 text-sm">
        Looking for Prodaktiv device nearby
      </p>
    </div>
...
const SuccessContent: React.FC = () => (
  <div className="text-center py-12 space-y-4">
    ...
    <div>
      ...
      <p className="text-zinc-500 text-sm">
        Prodaktiv device paired successfully
      </p>
    </div>
  </div>
);
