/**
 * Prodaktiv Device BLE Protocol Definitions
 *
 * This module defines the GATT services, characteristics, commands,
 * and events for communicating with the Prodaktiv focus timer device.
 */
...
// Custom Prodaktiv service UUID (for device filtering during scan)
export const Prodaktiv_SERVICE_UUID = '4c494e34-5234-4c49-4e33-345200000001';
