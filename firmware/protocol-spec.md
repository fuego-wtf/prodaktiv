# Prodaktiv BLE GATT Protocol Specification
...
Prodaktiv is a physical focus timer companion device that:
...
```
Device Name:        "Prodaktiv-XXXX"  (XXXX = last 4 chars of MAC)
...
Bytes 3-15:   Complete Local Name "Prodaktiv-XXXX"
...
```
Base: XXXXXXXX-1234-5678-9ABC-ProdaktivDEVICE
