<div align="center">
<img width="1200" height="475" alt="LIN34R Banner" src="https://github.com/user-attachments/assets/0aa67016-6eaf-458a-adb2-6e31a0763ed6" />
...
LIN34R is a productivity system designed for developers who want to:
...
LIN34R supports two deployment modes with a shared React codebase:
...
```bash
# Clone repository
git clone https://github.com/fuego-wtf/lin34r.git
cd lin34r
...
- [ ] Tauri shell with lin34r plugin
...
| Project | Description |
|---------|-------------|
| **lin34r-firmware** | ESP32 PlatformIO project (planned) |
